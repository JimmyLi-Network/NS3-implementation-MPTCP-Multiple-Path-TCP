/*UW -Madison CS740 Project by Yilong Li and Chuhan Gao 
...
This is the configuration code of simualtion. Compile with ./waf
*/
#include <iostream>
#include <sstream>
#include <string>
...
static const double simDuration    = 60.0;
...
/////////////////////////////////////////////
	...
	if(i==0)
	{
        	p2plink.SetDeviceAttribute ("DataRate", StringValue("500Mbps"));
        	p2plink.SetChannelAttribute("Delay", StringValue("1ms"));
	}	
	if(i==1)
	{
		p2plink.SetDeviceAttribute ("DataRate", StringValue("2000Mbps"));
                p2plink.SetChannelAttribute("Delay", StringValue("1ms"));
