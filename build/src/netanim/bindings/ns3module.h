...
extern PyTypeObject PyNs3AnimPacketInfo_Type;

extern std::map<void*, PyObject*> PyNs3AnimPacketInfo_wrapper_registry;
...
extern PyTypeObject PyNs3AnimRxInfo_Type;

extern std::map<void*, PyObject*> PyNs3AnimRxInfo_wrapper_registry;
...
typedef struct {
    PyObject_HEAD
    std::map< unsigned int, ns3::AnimRxInfo > *obj;
} Pystd__map__lt___unsigned_int__ns3__AnimRxInfo___gt__;


typedef struct {
    PyObject_HEAD
    Pystd__map__lt___unsigned_int__ns3__AnimRxInfo___gt__ *container;
    std::map< unsigned int, ns3::AnimRxInfo >::iterator *iterator;
} Pystd__map__lt___unsigned_int__ns3__AnimRxInfo___gt__Iter;


extern PyTypeObject Pystd__map__lt___unsigned_int__ns3__AnimRxInfo___gt___Type;
extern PyTypeObject Pystd__map__lt___unsigned_int__ns3__AnimRxInfo___gt__Iter_Type;
