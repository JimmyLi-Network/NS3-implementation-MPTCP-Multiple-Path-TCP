...
public:
    ...
    static PyObject * _wrap_GetInstanceTypeId(PyNs3CsmaChannel *self);
    ...
    static PyObject * _wrap_GetNDevices(PyNs3CsmaChannel *self);
    ...
    static PyObject * _wrap_GetDevice(PyNs3CsmaChannel *self, PyObject *args, PyObject *kwargs);
