...
initpoint_to_point_layout(void)
{
    ...
    /* Import the 'ns3::AsciiTraceHelperForIpv4' class from module 'ns.internet' */
    {
        ...
        _PyNs3AsciiTraceHelperForIpv4_Type = (PyTypeObject*) PyObject_GetAttrString(module, "AsciiTraceHelperForIpv4");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3AsciiTraceHelperForIpv4_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::AsciiTraceHelperForIpv6' class from module 'ns.internet' */
    {
        ...
        _PyNs3AsciiTraceHelperForIpv6_Type = (PyTypeObject*) PyObject_GetAttrString(module, "AsciiTraceHelperForIpv6");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3AsciiTraceHelperForIpv6_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::Ipv4AddressHelper' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv4AddressHelper_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv4AddressHelper");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3Ipv4AddressHelper_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::Ipv4InterfaceContainer' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv4InterfaceContainer_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv4InterfaceContainer");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3Ipv4InterfaceContainer_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::Ipv6InterfaceAddress' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv6InterfaceAddress_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv6InterfaceAddress");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3Ipv6InterfaceAddress_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::Ipv6InterfaceContainer' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv6InterfaceContainer_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv6InterfaceContainer");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3Ipv6InterfaceContainer_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::PcapHelperForIpv4' class from module 'ns.internet' */
    {
        ...
        _PyNs3PcapHelperForIpv4_Type = (PyTypeObject*) PyObject_GetAttrString(module, "PcapHelperForIpv4");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3PcapHelperForIpv4_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::PcapHelperForIpv6' class from module 'ns.internet' */
    {
        ...
        _PyNs3PcapHelperForIpv6_Type = (PyTypeObject*) PyObject_GetAttrString(module, "PcapHelperForIpv6");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3PcapHelperForIpv6_wrapper_registry");
        if (_cobj == NULL) {
    ...
    {
        PyObject *module = PyImport_ImportModule("ns.point_to_point");
        if (module == NULL) {
            return ;
        }
        _PyNs3PointToPointHelper_Type = (PyTypeObject*) PyObject_GetAttrString(module, "PointToPointHelper");
    ...
    /* Import the 'ns3::InternetStackHelper' class from module 'ns.internet' */
    {
        ...
        _PyNs3InternetStackHelper_Type = (PyTypeObject*) PyObject_GetAttrString(module, "InternetStackHelper");
    ...
    /* Import the 'ns3::Ipv6Header' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv6Header_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv6Header");
    ...
    /* Import the 'ns3::Ipv6' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv6_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv6");
    ...
    /* Import the 'ns3::Ipv6L3Protocol' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv6L3Protocol_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv6L3Protocol");
