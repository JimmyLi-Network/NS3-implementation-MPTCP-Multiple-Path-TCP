...
initolsr(void)
{
    ...
    /* Import the 'ns3::EventGarbageCollector' class from module 'ns.tools' */
    {
        ...
        _PyNs3EventGarbageCollector_Type = (PyTypeObject*) PyObject_GetAttrString(module, "EventGarbageCollector");
    
        if (PyErr_Occurred()) PyErr_Clear();
        PyObject *_cobj = PyObject_GetAttrString(module, "_PyNs3EventGarbageCollector_wrapper_registry");
        if (_cobj == NULL) {
    ...
    /* Import the 'ns3::Ipv4StaticRouting' class from module 'ns.internet' */
    {
        ...
        _PyNs3Ipv4StaticRouting_Type = (PyTypeObject*) PyObject_GetAttrString(module, "Ipv4StaticRouting");
