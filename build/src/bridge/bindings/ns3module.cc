...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_GetInstanceTypeId(PyNs3BridgeChannel *self)
{
    PyObject *py_retval;
    PyNs3BridgeChannel__PythonHelper *helper = dynamic_cast< PyNs3BridgeChannel__PythonHelper* >(self->obj);
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_GetNDevices(PyNs3BridgeChannel *self)
{
    PyObject *py_retval;
    uint32_t retval;
    PyNs3BridgeChannel__PythonHelper *helper = dynamic_cast< PyNs3BridgeChannel__PythonHelper* >(self->obj);
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method GetNDevices of class BridgeChannel is protected and can only be called by a subclass");
        return NULL;
    }
...
PyObject *
PyNs3BridgeChannel__PythonHelper::_wrap_GetDevice(PyNs3BridgeChannel *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method GetDevice of class BridgeChannel is protected and can only be called by a subclass");
        return NULL;
    }
...
static PyMethodDef PyNs3BridgeChannel_methods[] = {
    ...
    {(char *) "_NotifyConstructionCompleted", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_NotifyConstructionCompleted, METH_NOARGS, NULL },
    {(char *) "_NotifyNewAggregate", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_NotifyNewAggregate, METH_NOARGS, NULL },
    {(char *) "_GetInstanceTypeId", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_GetInstanceTypeId, METH_NOARGS, NULL },
    {(char *) "_DoStart", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_DoStart, METH_NOARGS, NULL },
    {(char *) "_GetNDevices", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_GetNDevices, METH_NOARGS, NULL },
    {(char *) "_DoDispose", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_DoDispose, METH_NOARGS, NULL },
    {(char *) "_GetDevice", (PyCFunction) PyNs3BridgeChannel__PythonHelper::_wrap_GetDevice, METH_KEYWORDS|METH_VARARGS, NULL },
    {NULL, NULL, 0, NULL}
};
