...
public:
    ...
    static PyObject * _wrap_Default(PyNs3NoneFileConfig *self);
    inline void Default__parent_caller()
    { ns3::NoneFileConfig::Default(); }

    static PyObject * _wrap_Attributes(PyNs3NoneFileConfig *self);
    inline void Attributes__parent_caller()
    { ns3::NoneFileConfig::Attributes(); }

    static PyObject * _wrap_Global(PyNs3NoneFileConfig *self);
    inline void Global__parent_caller()
    { ns3::NoneFileConfig::Global(); }

    static PyObject * _wrap_SetFilename(PyNs3NoneFileConfig *self, PyObject *args, PyObject *kwargs);
    inline void SetFilename__parent_caller(std::string filename)
...
public:
    ...
    static PyObject * _wrap_GetInstanceTypeId(PyNs3ConfigStore *self);
