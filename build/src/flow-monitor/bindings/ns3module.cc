...
PyObject *
PyNs3FlowMonitor__PythonHelper::_wrap_GetInstanceTypeId(PyNs3FlowMonitor *self)
{
    PyObject *py_retval;
    PyNs3FlowMonitor__PythonHelper *helper = dynamic_cast< PyNs3FlowMonitor__PythonHelper* >(self->obj);
    ...
    if (helper == NULL) {
        PyErr_SetString(PyExc_TypeError, "Method GetInstanceTypeId of class FlowMonitor is protected and can only be called by a subclass");
        return NULL;
    }
...
static PyMethodDef PyNs3FlowMonitor_methods[] = {
    ...
    {(char *) "_NotifyConstructionCompleted", (PyCFunction) PyNs3FlowMonitor__PythonHelper::_wrap_NotifyConstructionCompleted, METH_NOARGS, NULL },
    {(char *) "_NotifyNewAggregate", (PyCFunction) PyNs3FlowMonitor__PythonHelper::_wrap_NotifyNewAggregate, METH_NOARGS, NULL },
    {(char *) "_DoDispose", (PyCFunction) PyNs3FlowMonitor__PythonHelper::_wrap_DoDispose, METH_NOARGS, NULL },
    {(char *) "_DoStart", (PyCFunction) PyNs3FlowMonitor__PythonHelper::_wrap_DoStart, METH_NOARGS, NULL },
    {(char *) "_GetInstanceTypeId", (PyCFunction) PyNs3FlowMonitor__PythonHelper::_wrap_GetInstanceTypeId, METH_NOARGS, NULL },
