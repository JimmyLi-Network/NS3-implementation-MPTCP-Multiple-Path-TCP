...
extern PyTypeObject *_PyNs3Ipv4L4Protocol_Type;
#define PyNs3Ipv4L4Protocol_Type (*_PyNs3Ipv4L4Protocol_Type)
...
public:
    ...
    static PyObject * _wrap_GetInstanceTypeId(PyNs3FlowMonitor *self);
